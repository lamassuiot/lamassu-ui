...
import AsymmetricKMSTable from "components/KMS/AsymmetricKmsTable";
...
export const AsymmetricKmsListView = () => {
            ...
            <Grid container flexDirection={"column"} spacing={"20px"}>
                ...
                <Grid xs >
                    <Box component={Paper} borderRadius={"15px"}>
                        <AsymmetricKMSTable ref={tableRef} query={query} filter={filter} onRowClick={(row) => {
